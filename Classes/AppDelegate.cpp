...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	// set Global Size
	cocos2d::Size g_visibleSize = Size(cocos2d::Director::getInstance()->getVisibleSize());
	cocos2d::Point g_origin	 =  Point(cocos2d::Director::getInstance()->getVisibleOrigin());
	...
	Scene *pScene = MonsterMaker::Scenes::Mains::create();
